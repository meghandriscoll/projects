...
% start log file
dateStr = date;
diary([mainPath 'log2' dateStr '.txt'])
...
% %%%%%%%%% This one get the RES error in snake
% %%%%%%% ax3 glass (100120_3) %%%%%%%
...
% shapes(parameters)
% 
% Error using snakeinterp1 (line 37)
% RES too big compare to the length of original curve
% 
% Error in findSnakes>(parfor body) (line 118)
%         [distX, distY] = snakeinterp1(XSnake,YSnake,params.dmin);
% 
% Error in parallel_function (line 479)
%             consume(base, limit, F(base, limit, supply(base, limit)));
% 
% Error in findSnakes (line 41)
% parfor i=1:N
% 
% Error in shapes (line 199)
%     M = findSnakes(N, paramsSnake, inDirectory, savePath);
% 
% Error in accumulateShapes2 (line 109)
% shapes(parameters)
