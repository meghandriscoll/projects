...
function accumulateShapesPar()

%%%%%%% TURN INDIVIDUAL SHAPE PROGRAMS ON AND OFF %%%%%%%%%%%%%%%%%%%%%%%%%
% extract and analyze shapes
parameters.run(1) = 0;     % read directory (did this!)
parameters.run(2) = 1;     % find the approximate boundaries (did this!)
parameters.run(3) = 1;     % track blobs
...
parameters.verify(3) = 1;    % plot the snake boundaries
...
parfor movie=1:3
    ...
    if movie==1
        ...
        parameters1.inDirectory = [mainPath directoryPath '/'];
        parameters1.savePath = [mainPath directoryPath '/saveData/'];
        parameters1.lineAngle = 0;
        parameters1.lineSep = 0;
        parameters1.type='ax3_glass';
        shapes(parameters1)
    ...
    elseif movie==2
        ...
        parameters2.inDirectory = [mainPath directoryPath '/'];
        parameters2.savePath = [mainPath directoryPath '/saveData/'];
        parameters2.lineAngle = 0;
        parameters2.lineSep = 0;
        parameters2.type='ax3_glass';
        shapes(parameters2)
    ...
    elseif movie==3 
        ...
        parameters3.inDirectory = [mainPath directoryPath '/'];
        parameters3.savePath = [mainPath directoryPath '/saveData/'];
        parameters3.lineAngle = 0;
        parameters3.lineSep = 0;
        parameters3.type='ax3_glass';
        shapes(parameters3)
